...
public class CoursePointDialog extends Dialog {
    ...
    public CoursePointDialog(Context context, String name, String jd,
                             String wd){
...
//        gridCancel = (Button) view.findViewById(R.id.changeicon_cancel);
    ...
    public void initGridView() {
        ...
        mGridView.setOnItemClickListener((parents, view, position1, arg3) -> {
//                gridPosition = position + 1;
//                Logger.i("aaa"+gridPosition);
            setPosition(position1);
            iv_tubiao.setBackgroundResource(Constant.hdImage[position1]);
            dialog.dismiss();
        });
    }
